 ...
 * @method static ?string loadFromRequest(\Illuminate\Http\Request $request)
 ...
 * @method static void storeUserPem(\Illuminate\Contracts\Auth\Authenticatable  $user, string $privateKey, ?int $hours = null)
